...
public class MyComponentsListRecyclerViewAdapter extends RecyclerView.Adapter<MyComponentsListRecyclerViewAdapter.ViewHolder> {
    private final ArrayList<String> mValues;

    MyComponentsListRecyclerViewAdapter(ArrayList<String> items) {
        mValues = items;
    }
